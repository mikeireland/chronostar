# -*- coding: utf-8 -*-
"""
Created on Wed Feb 16 10:18:18 2022

@author: nstanden
"""
#New version of chronostar.likelihood.py that includes the
    #age overlap of a star.
"""
...
def get_probs_atage(comp, data):
    """
     Given the parametric description of an origin, and a stellar
     age pdf, get the probability of the star at that age.
    ----------
    comp : [npars] list
    ...
    data : dict
        ...
        'age_pdfs':[nstars,64] float array
            the age pdf of each star

    Returns
    -------
    [nstars] float array
        the probability at the component's age for each.

    """
    agemyr=comp['age']
    lnage=np.log10(agemyr*10**6)
    get_prob_ages= lambda pdf:  hp.get_probage(lnage, pdf)
    return get_prob_ages(data['age_pdfs'])   
