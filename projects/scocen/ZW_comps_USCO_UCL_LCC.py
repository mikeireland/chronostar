...
for i, c in enumerate(comps):
    ...
    #~ print(label)
    ax.errorbar(t['Z'], t['W'], xerr=t['Z_error'], yerr=t['W_error'], c=colors[comp_ID], fmt='o', markersize=markersize, lw=lw, zorder=zorder, label = label, markeredgewidth=0.2, markeredgecolor=markeredgecolor)
