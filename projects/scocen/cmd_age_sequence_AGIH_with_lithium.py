...
colors = lib.colors
############################################
# Components H and I are IC2602 and Platais 8 that are older but don't have the same age.
# Check if the literature says one is older than another, but we show here that it's the other way around.
comps_to_plot = ['A', 'G', 'H', 'I'] # AGE SEQUENCE IS REAL!!! ['C', 'A', 'U', 'G', 'F', 'T']
############################################
...
plt.savefig('cmd_li_AGIH_90percent_membership.pdf')
plt.show()
