...
for i, c in enumerate(comps):
    ...
    ax.errorbar(t['Z'], t['W'], xerr=t['X_error'], yerr=t['U_error'], c=colors[comp_ID], fmt='o', markersize=3, lw=lw, zorder=zorder, label = '%s (%.2f$\pm$%.2f Myr) %d'%(comp_ID, age, c['Age_reliable'], len(t)))
