...
def get_lnoverlaps(*args):
  return _expectation.get_lnoverlaps(*args)
get_lnoverlaps = _expectation.get_lnoverlaps

def get_all_lnoverlaps(*args):
  return _expectation.get_all_lnoverlaps(*args)
get_all_lnoverlaps = _expectation.get_all_lnoverlaps

def calc_membership_probs(*args):
  return _expectation.calc_membership_probs(*args)
calc_membership_probs = _expectation.calc_membership_probs

def expectation(*args):
  return _expectation.expectation(*args)
