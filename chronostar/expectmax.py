...
def maximisation_parallel_external(data, ncomps, memb_probs, burnin_steps, idir,
                 all_init_pars, all_init_pos=None, plot_it=False, pool=None,
                 convergence_tol=0.25, ignore_dead_comps=False,
                 Component=SphereComponent,
                 trace_orbit_func=None,
...
def maximisation_parallel_external_scipy_optimise(data, ncomps, memb_probs, burnin_steps, idir,
    ...
    if ncomps==1:
        ...
        bashCommand = 'mpirun -np %d python run_maximisation_all_comps_scipy.py %s %s'%(ncomps, filename_global_pars, filenames_pars_filename)
...
def fit_many_comps(data, ncomps, rdir='', pool=None, init_memb_probs=None,
                   ...
                   nthreads=1, filename_global_pars=None,
                   **kwargs):
    """
    ...
    while not all_converged and stable_state and iter_count < max_em_iterations:
        ...
        new_comps, all_samples, _, all_init_pos, success_mask =\
            maximisation_parallel_external(data, ncomps=ncomps,
                         ...
                         nthreads=nthreads,
                         filename_global_pars=filename_global_pars,
                         )
...
def fit_many_comps_scipy(data, ncomps, rdir='', pool=None, init_memb_probs=None,
                   init_comps=None, inc_posterior=False, burnin=1000,
                   sampling_steps=5000, ignore_dead_comps=False,
                   Component=SphereComponent, trace_orbit_func=None,
                   use_background=False, store_burnin_chains=False,
