...
def run_expectmax_simple(pars, data_dict=None, init_comps=None, 
    ...
    while not converged and iter_count < pars['max_em_iterations']:
        ...
        comps_new, _, all_init_pos =\
            expectmax.maximisation_gradient_descent_multiprocessing(data_dict, 
                ncomps=ncomps, convergence_tol=pars['convergence_tol'],
        ...
        #### EXPECTATION ###############################################
        ################################################################
        memb_probs_new = expectmax.expectation(data_dict, comps_new, 
        ...
        overall_lnlike = expectmax.get_overall_lnlikelihood(data_dict, 
