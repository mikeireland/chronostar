...
Take Beta Pic and perform two fits (this file only performs one at the time): one where all stars have known radial velocities,
and one where some of them have broken values (radial_velocity=0, radial_velocity_error=1e+5).
"""
